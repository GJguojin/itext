...
public class DocumentExample {
	...
	private static String FILE_DIR = "E:\\itext\\doc\\";
	...
	private void setWatermark() throws Exception {
		...
		Image img = Image.getInstance(getClass().getResource("/resource/watermark.jpg"));
		...
		over.showTextAligned(Element.ALIGN_LEFT, "测试测试测试", 230, 430, 45);
		over.endText();
		
		//背景图
		Image img2 = Image.getInstance(getClass().getResource("/resource/test.jpg"));
	...
	private void addExtraContent() throws Exception {
		...
		//Image对象
		document.newPage();
		Image img = Image.getInstance(getClass().getResource("/resource/test.jpg"));
	...
	private void setAnnotation() throws Exception {
		...
		String file = getClass().getResource("/resource/test2.jpg").getFile();
